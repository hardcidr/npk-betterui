...
# curl https://raw.githubusercontent.com/hardcidr/npk-betterui/main/cloudshell_install_dev.sh | bash
...
if [[ ! -f /aws/mde/npk/README.md ]]; then
	...
	git clone -b devel https://github.com/hardcidr/npk-betterui.git /aws/mde/npk > /dev/null
fi
